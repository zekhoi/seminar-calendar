...
import UpcomingEvent from "../item/UpcomingEvent";
    ...
    <>
      <div className="flex items-center justify-center min-h-screen px-4 py-8 text-gray-700 bg-basecolor">
        <div className="w-full max-w-sm shadow-lg">
                          ...
                          >
                            <div
                              className={`flex justify-center w-full px-2 py-2 rounded-full ${
                                ...
                                day.status === "current"
                                  ? "bg-danger"
                                  : "hover:cursor-pointer hover:bg-danger hover:text-white"
                              }`}
                            >
                              {isToday(
                                events,
          ...
          <div className="py-5 pb-8 overflow-y-auto rounded-b bg-gray-50 max-h-96">
            <div className="px-8">
